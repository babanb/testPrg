...
var prevtext = "", nexttext = "", endtour = "", pausetour = "", resumetour = "";

! function (t, e) {
    var translations = GetTranstaltionForTour();
    prevtext = translations.sPrevious;
    nexttext = translations.sNext;
    resumetour = translations.sResume;
    pausetour = translations.sPause;
    endtour = translations.sEndTour;
    ...
    return n = e.document, o = function () {
        function o(o) {
            ...
            this._options = t.extend({
                ...
                delay: !1,
                basePath: "",
                template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <hr> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-default" data-role="prev">&laquo;</button> <button class="btn btn-sm btn-default" data-role="next">&raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="' + pausetour + '" data-resume-text="' + resumetour + '">' + pausetour + '</button> </div> <button class="btn btn-sm btn-default" data-role="end">' + endtour + '</button> </div> </div>',
                afterSetState: function () { },
                afterGetState: function () { },
                afterRemoveState: function () { },
                onStart: function () { },
                onEnd: function () { /*window.location.href = 'index.html';*/ },
                onShow: function () { },
                onShown: function () { },
                onHide: function () { },
                onHidden: function () { },
