...
namespace ADOPets.Web.ViewModels.Account
{
    public class SelectPlanViewModel
    {
        ...
        public SelectPlanViewModel(Model.Subscription subModel)
        {
            ...
            {
                lstPlanData = new PlanDetailsViewModel(subModel.PlanFeatures.First(), subModel);
            }
            else
            {
                lstPlanData = new PlanDetailsViewModel(true, subModel);
            }
        }
    ...
    {
        public PlanDetailsViewModel(Model.PlanFeature planFeature, Model.Subscription subModel)
        {
        ...
        public PlanDetailsViewModel(bool isFeature, Model.Subscription subModel)
        {
            string planTypeName = (subModel.PlanType != null) ? subModel.PlanType.Name : string.Empty;
            PlanType = planTypeName;
            Price = subModel.Amount.ToString();
