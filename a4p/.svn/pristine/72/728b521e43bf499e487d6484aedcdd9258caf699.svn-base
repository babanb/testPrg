...
{
    public class ExpertViewDetials
    {
        public ExpertViewDetials()
        {
        }

        public ExpertViewDetials(Model.EConsultation ec)
        {
            Id = ec.ID;
            PetId = ec.Pet.PetId;
            Name = ec.Pet.Name;
            ...
            if (ec.CountryId != null)
            {
                Country = (CountryEnum)ec.CountryId;
            }
            else
            {
