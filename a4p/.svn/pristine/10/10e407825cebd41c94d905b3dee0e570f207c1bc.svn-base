...
{
    public class JoinEConsultationModel
    {
        public JoinEConsultationModel()
        {

        }

        public JoinEConsultationModel(Model.EConsultation ec)
        {
            Id = ec.ID;
            PetId = ec.Pet.PetId;
            Name = ec.Pet.Name;
            ...
            VetId = ec.VetId;
            if ( ec.EConsultationContactTypeId != null)
            {
