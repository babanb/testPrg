...
{
    /// <summary>
    /// Summary description for EcFileUploadHandler
    /// </summary>
    public class EcFileUploadHandler : IHttpHandler
    {
                ...
                if (context.Request.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < context.Request.Files.Count; i++)
                    {
                        ...
                        if (file.ContentLength > 0)
                        {
                            ...
                            var dirPath = Path.Combine(WebConfigHelper.UserFilesPath, infoPath, uid, Constants.PetsFolderName, context.Request.Form[1].ToString(), Constants.DocumentFolderName, Constants.ECFolderName, context.Request.Form[2].ToString(), Constants.DocumentFolderName);
