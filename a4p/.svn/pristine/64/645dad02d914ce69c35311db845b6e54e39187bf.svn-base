...
namespace ADOPets.Web.Common.Authentication
{
    public class CustomRoleProvider : RoleProvider
    {
        ...
        /// </param><param name="roleName">The role to search in.</param>
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            {
                var login = uow.LoginRepository.GetByUserName(username, l => l.User);

                if (login != null && login.User != null)
                {
                    userRoles = new[] {login.User.UserTypeId.ToString()};
                }
            }
